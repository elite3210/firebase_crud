  ...
  export const guardarProduct = (categoria,codigo,nombre,color,unidad, precio_anterior,precio,descripcion,active)=>{addDoc(collection(db,'Productos'),{categoria,codigo,nombre,color,unidad, precio_anterior,precio,descripcion,active})}
