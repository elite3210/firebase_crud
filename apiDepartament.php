...
try {
    ...
    switch ($method) {
        ...
        case 'POST':
            ...
            $stmt = $pdo->prepare("INSERT INTO Departments (department_name,location,manager_id) VALUES (?,?,?)");
            $stmt->execute([$data['department_name'], $data['location'], $data['manager_id']]);
            echo json_encode(['message' => 'Departmento creado exitosamente']);
            break;
