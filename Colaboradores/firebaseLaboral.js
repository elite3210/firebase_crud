...
//sospecho que todo lo que sigue abajo los exportados deben implementarse en su respectivo modulo, ya que se ejecuta varias veces con cada pagina
  ...
  export const guardarTask        = (title,description,salida,dniColaborador,horario,payStatus)=>{addDoc(collection(db,'Micoleccion'),{title,description,salida,dniColaborador,horario,payStatus})}
  ...
  export const guardarTransaccionesLaboral = (fechaTransaccion,dniColaborador,numeroTicket,creado,descripcion,tipoTransaccion,importe,importeHaber)=>{addDoc(TransaccionesLaboral,{fechaTransaccion,dniColaborador,numeroTicket,creado,descripcion,tipoTransaccion,importe,importeHaber})}
